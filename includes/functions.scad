...
//Determines if a variable is a vector, true if it is, false otherwise. Generates a warning but is harmless. This is a diry hack and is not an OpenSCAD
//language feature. It may break in a future version of OpenSCAD.
function isVector(var) = len(var) == undef ? false : true;
